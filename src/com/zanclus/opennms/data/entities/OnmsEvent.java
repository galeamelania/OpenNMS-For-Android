...
public class OnmsEvent extends OnmsEntity implements Serializable {
	...
	/** persistent field */
	private com.zanclus.opennms.data.entities.OnmsNode m_node;
	...
	public OnmsEvent(Integer eventid, String eventuei, Date eventtime,
			...
			OnmsAlarm alarm, com.zanclus.opennms.data.entities.OnmsNode node,
	...
	public OnmsEvent(Integer eventid, String eventuei, Date eventtime,
			...
			com.zanclus.opennms.data.entities.OnmsNode node, Set<OnmsNotification> notifications,
