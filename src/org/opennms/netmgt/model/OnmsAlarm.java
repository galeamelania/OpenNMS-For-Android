 ...
 */
@Root(name="alarm")
public class OnmsAlarm extends OnmsEntity implements Acknowledgeable, Serializable {
     ...
     */
    public OnmsAlarm(Integer alarmid, String eventuei, Integer counter, Integer severity, Date firsteventtime, OnmsEvent event) {
        this.m_id = alarmid;
        this.m_uei = eventuei;
     ...
     * @return a {@link java.util.Date} object.
     */
    @Element(name="firstAutomationTime")
     ...
     * @return a {@link java.util.Date} object.
     */
    @Element(name="lastAutomationTime")
